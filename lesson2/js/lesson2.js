...
Vue.createApp({
    ...
    // для вывода отфильтрованных и отсортированных данных используются вычисляемые свойства
    computed: {
        sortedByTitle() {
            // геттер для свойств sortedByTitle, который возвращает значение этого свойства:
